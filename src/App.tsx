...
import ChartDashboardPage from "./pages/chart-dashboard"
          ...
          <Container component="main" sx={{ mt: 4, mb: 4, flex: "1 0 auto" }}>
            ...
            >
              ...
              >
                ...
                <Tab label={getTabLabel("Charts")} />
                <Tab label={getTabLabel("Chart Dashboard")} />
                {/* <Tab label={getTabLabel("Overlay")} /> */}
              </Tabs>
            </Box>
            ...
            {activeTab === 7 && <ChartsPage />}
            {activeTab === 8 && <ChartDashboardPage />}
